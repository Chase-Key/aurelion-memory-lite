...
- **aurelion-memory-lite** (this module) — File-based knowledge graph & MCP server
- **[aurelion-kernel-lite](https://github.com/chase-key/aurelion-kernel-lite)** — Cognitive structure templates (5-floor content scaffolding)
- **[aurelion-advisor-lite](https://github.com/chase-key/aurelion-advisor-lite)** — Career strategy & planning frameworks
- **[aurelion-agent-lite](https://github.com/chase-key/aurelion-agent-lite)** — AI collaboration protocols & integrity triggers
- **[aurelion-nexus](../../nexus/aurelion-nexus/)** — World engine & agent system (coming soon)
...
**Need templates?** Install [aurelion-kernel-lite](https://github.com/chase-key/aurelion-kernel-lite) for the content structure, then use this module as the knowledge graph engine. See the [AURELION Hub](https://github.com/chase-key/aurelion-hub) for the full ecosystem.
